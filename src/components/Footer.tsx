...
export default function Footer({ onNavigate }: { onNavigate: (t: string) => void }) {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-line px-6 pt-28 md:px-10 md:pt-40">
      <div className="flex flex-col items-start">
        ...
        <Magnetic strength={0.15} className="w-fit">
          <motion.button
            ...
            className="group flex items-center gap-3 font-display text-[11vw] font-semibold uppercase leading-[0.85] tracking-tight text-paper md:text-[9vw]"
          ...
          >
            ...
            <ArrowUpRight
              className="h-[8vw] w-[8vw] text-acid transition-transform duration-500 group-hover:rotate-45 md:h-[6vw] md:w-[6vw]"
              strokeWidth={1.2}
            />
          </motion.button>
        </Magnetic>
      ...
      <div className="mt-24 border-t border-line py-10 md:mt-32 md:py-12">
        ...
        <div className="grid grid-cols-2 gap-6 font-mono text-[13px] font-semibold md:grid-cols-3 lg:grid-cols-6 md:text-[14px]">
          ...
          <a data-cursor="hover" href="mailto:sabermrddz@gmail.com" className="text-center text-paper underline decoration-white/20 underline-offset-4 transition-colors hover:text-acid hover:decoration-acid">
            sabermrddz@gmail.com
          </a>
          <span className="text-center font-medium tracking-[0.02em] text-paper/80">Batna, DZ — 36.75°N 5.77°E</span>
          ...
          <div className="col-span-2 flex justify-center md:col-span-3 lg:col-span-1 lg:justify-end">
